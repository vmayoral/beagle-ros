...
SECTION = "devel"
LICENSE = "BSD"
LIC_FILES_CHKSUM = "file://LICENSE;md5=4899473e78369893d3ddc4a151717465"
...
FILES_${PN} += "${libdir}/liburdfdom_model.so \
                ${libdir}/liburdfdom_model_state.so \
                ${libdir}/liburdfdom_sensor.so \
                ${libdir}/liburdfdom_world.so"
inherit ros cmake
